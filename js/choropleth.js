...
class MapVis {
    ...
    constructor(parentElement, sharksData, geoData) {
            ...
            d3.drag()
                ...
                .on("drag", function (event) {
                    ...
                    d3.selectAll('.connection')
                        .attr("x1", function (d) {
                            return vis.projection([vis.sharksData.nodes[d.source].longitude, vis.sharksData.nodes[d.source].latitude])[0];
                        })
                        .attr("y1", function (d) {
                            return vis.projection([vis.sharksData.nodes[d.source].longitude, vis.sharksData.nodes[d.source].latitude])[1];
                        })
                        .attr("x2", function (d) {
                            return vis.projection([vis.sharksData.nodes[d.target].longitude, vis.sharksData.nodes[d.target].latitude])[0];
                        })
                        .attr("y2", function (d) {
                            return vis.projection([vis.sharksData.nodes[d.target].longitude, vis.sharksData.nodes[d.target].latitude])[1];
                        });
                })
        );
